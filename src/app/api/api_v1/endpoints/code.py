...
from app.schemas.code import ChatHistory, ChatRole, UserMessage
...
async def chat(
    payload: Union[UserMessage, ChatHistory],
    ...
    return StreamingResponse(
        ollama_client.chat(
            ...
            if isinstance(payload, ChatHistory)
            else [{"role": ChatRole.USER, "content": payload.content}]
